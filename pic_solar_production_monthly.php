...
#require_once ($jpgraph_dir."UniversalTheme.class.php");

$datafile = "dect_monthly_116300145548.data";
$datafile_einspeise = "/var/www/html/smart_data/smart_meter_einspeise_summary_monthly.data";
$datafile_verbrauch = "/var/www/html/smart_data/smart_meter_verbrauch_summary_monthly.data";
$current_einspeise = "/var/www/html/smart_data/smart_meter_einspeise.data";
$current_verbrauch = "/var/www/html/smart_data/smart_meter_verbrauch.data";
$current_solar = "/var/www/html/dect_30secs_116300145548.data";
$data = array();
...
$graph->title->Set("Stromverbrauch, -erzeugung und -einspeisung");
$graph->xaxis->title->Set("Zeit");
$graph->yaxis->title->Set("Stromerzeugung in kWh");
